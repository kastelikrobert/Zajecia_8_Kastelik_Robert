...
// sta³e do obs³umi menu podrêcznego
enum
{
	CSG_A, // tylko Kula
	CSG_B, // tylko Torus
	CSG_C, // tylko Ostros³up
	CSG_A_OR_B,
	CSG_A_OR_C,
	CSG_A_AND_B,
	CSG_A_SUB_B,
	CSG_B_SUB_A,
	CSG_C_SUB_A,
	CSG_OSTROSLUP_SUB_Kula_OR_TORUS_AND_KULA,
...
void GenerateDisplayLists()
{
	...
	// zielona kula
	glColor4fv(YellowGreen);
	glutSolidTorus(.4, 1, 100, 100);
...
int main(int argc, char * argv[])
{
	...
	glutAddMenuEntry("C_SUB_A_OR_B_AND_A", CSG_OSTROSLUP_SUB_Kula_OR_TORUS_AND_KULA);
